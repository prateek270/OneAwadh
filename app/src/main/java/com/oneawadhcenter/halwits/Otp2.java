...
public class Otp2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new resendOtp().execute("http://oneawadhcenter.com/api/send_otp/"+u_id+"/"+num+"/1");
    ...
    class verifyOtp extends AsyncTask<String,Void,String>
    {
        ...
        protected void onPreExecute() {
            ...
            progressDialog=new ProgressDialog(Otp2.this);
        ...
        protected void onPostExecute(String result) {
            ...
            if(status.equals("success"))
            {
                ...
                Toast.makeText(Otp2.this, "Success", Toast.LENGTH_SHORT).show();

                Intent eIntent=new Intent(Otp2.this,ChangePass.class);
                eIntent.putExtra("Id",u_id);
            ...
            else
            {
                ...
                Toast.makeText(Otp2.this,message, Toast.LENGTH_LONG).show();
