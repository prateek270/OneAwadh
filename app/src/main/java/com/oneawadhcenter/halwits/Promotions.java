...
public class Promotions extends Activity {
    ...
    public static String url = "http://www.oneawadhcenter.com/api/promotion_list";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custom_promotions);

        context = this;
        Kontext.startInit(this)
        .autoPromptLocation(true)
        .setNotificationOpenedHandler(new ExampleNotificationOpenedHandler())
        .setNotificationReceivedHandler(new ExampleNotificationReceivedHandler()).init();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent RoomButtonIntent=new Intent(Promotions.this,navigation.class);
    ...
    private class ExampleNotificationReceivedHandler implements Kontext.NotificationReceivedHandler {
        @Override
        public void notificationReceived(OSNotification notification) {
            Log.w("KontextExample", "notificationReceived!!!!!!");
            //DebuggingHelper.printObject(notification);
            //DebuggingHelper.printObject(notification.payload);
        }
    }

    private class ExampleNotificationOpenedHandler implements Kontext.NotificationOpenedHandler {
        @Override
        public void notificationOpened(OSNotificationOpenResult openedResult) {
            Log.w("KontextExample", "notificationOpened!!!!!!");
    ...
    public void onBackPressed() {
       // super.onBackPressed();
        Intent i=new Intent(Promotions.this,navigation.class);
        startActivity(i);
    }
    ...
    private class GetPromotions extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Promotions.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i <contacts.length(); i++) {
                        ...
                        String name = c.getString("promotion_title");

                        String desc = c.getString("promotion_description");
                        String img = c.getString("promotion_image");

                        String temp1=name.replace("&#39;","'");
                        name=temp1;
                        String temp=desc.replace("&#39;","'");
                        desc=temp;
                        //String butt=c.getString("floor_no");
                        //String num=c.getString("shope_no");
                        String bn=c.getString("brand_name");
                        if(!bn.equals("null"))
                        {
                            name=name+" on "+bn;
        ...
        protected void onPostExecute(Void result) {
            ...
            adapter=new custom_adapter_promo(Promotions.this,getApplicationContext(),arrayList);
